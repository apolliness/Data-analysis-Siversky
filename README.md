...
![границы территории](нулевой сценарий/qgis/1.границы территории.png)

3. Получение геометрии водных объектов, улично-дорожной сети и железных дорог с помощью библиотеки OSMNX.
   
![вода, жд и дороги](нулевой сценарий/qgis/2.вода, жд и дороги.png)

5. Получение слоя городских кварталов с помощью BlocksGenerator. На вход были поданы следующие данные: водные объекты, дороги, железнодорожные пути.
6. Получение графа улично-дорожной сети по полигону территории с помощью библиотеки IduEdu.
7. Вычисление матрицы доступности и матрицы связанности на основе предварительно полученного графа улично-дорожной сети.
- Матрица доступности: 
